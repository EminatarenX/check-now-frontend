            ...
            <section className="bg-emerald-200 rounded-tl-[100px] rounded-br-[100px] p-14 lg:p-20 ">
               ...
               <Regresar/>
                <div className="flex justify-between mt-5 gap-5 lg:w-1/2">
                    <button className="p-2 rounded bg-emerald-100 text-cyan-700 shadow font-semibold w-full lg:w-1/3">
                        Editar
                    </button>
                    <button className="p-2 rounded bg-emerald-100 text-red-700 shadow font-semibold w-full lg:w-1/3">
                       Eliminar
                    </button>
                </div>
                {
                    loading || !plaza ? <p>Cargando...</p> : (
                        <>
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-5">
                                ...
                                <article className="flex flex-col bg-white shadow-lg p-5 rounded">
                                ...
                                <article className={`${plaza.empreado ? 'bg-white rounded p-5' : ''}`}>
                                    ...
                                    {
                                        !plaza.empleado ? (
                                            <p className="text-center">No hay empleado</p>
                                        ) : (
                                            <p>Hay empreado</p>
                                        )
                                    }
