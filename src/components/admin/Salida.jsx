...
export default function Salida({salida}) {
  ...
  return (
    <div className="bg-rose-800 flex justify-between rounded w-full p-4 min-w-[800px] animate-entrada">
    ...
    <div className="flex gap-2">
        <button className="bg-cyan-700 text-white px-2 py-1 rounded">Editar</button>
        <button className="bg-red-600 text-white px-2 py-1 rounded">Eliminar</button>
    </div>
